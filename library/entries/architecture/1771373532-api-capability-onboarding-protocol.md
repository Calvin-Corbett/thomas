...
- id: `1771373532-api-capability-onboarding-protocol`
- category: `architecture`
- source: docs/API_CAPABILITY_ONBOARDING_PROTOCOL.md
- created_ts_utc: 1771373532
- tags: protocol, onboarding, capabilities, parity, testing
- query: robust protocol for adding api capabilities

## Summary
Required process for adding non-chat API capabilities (video, voice, batch, realtime, tools) with UI/CLI parity and tests.
