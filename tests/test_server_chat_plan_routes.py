...
from thomas.server.routes.chat_plan_mode import normalize_conversation_mode
...
class TestExecutionPlanRoundTrip(unittest.TestCase):
    ...
    def test_normalize_conversation_mode_accepts_production_aliases(self) -> None:
        self.assertEqual(normalize_conversation_mode("production"), "production")
        self.assertEqual(normalize_conversation_mode("swarm"), "production")
