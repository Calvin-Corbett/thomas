...
def test_monolith_guard_fails_for_unbaselined_oversized_file(tmp_path: Path) -> None:
    ...
    assert report["violations"][0]["suggested_split_paths"] == [
        "thomas/feature/huge_module_helpers.py",
        "thomas/feature/huge_module_types.py",
        "thomas/feature/huge_module_services.py",
    ]
    assert "Extract helpers" in report["violations"][0]["suggested_remediation"]
