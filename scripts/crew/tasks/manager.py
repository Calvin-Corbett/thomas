...
try:
    import scripts.crew.tasks.sweep as workboard_task_manager_sweep
    ...
    from scripts.crew.tasks.messages import (
        _capture_task_ecosystem_preference,
        _monitor_loop,
        _specialist_for_task,
        _sync_task_specialists,
        dispatch_idle_agents_once,  # noqa: F401  # re-exported for workboard/worker.py
    )
    from scripts.crew.tasks.plans import _sync_task_plans
    from scripts.crew.tasks.reactivate import (
        _auto_start_task_for_agent,
        _reactivate_task,
        _resolve_auto_start_agent,
        set_task_status,
    )
    from scripts.crew.tasks.sessions import (
    ...
    from crew.tasks.messages import (
        _capture_task_ecosystem_preference,
        _monitor_loop,
        _specialist_for_task,
        _sync_task_specialists,
    ...
    from crew.tasks.plans import _sync_task_plans
    from crew.tasks.reactivate import (
        _auto_start_task_for_agent,
        _reactivate_task,
        _resolve_auto_start_agent,
        set_task_status,
    )
    from crew.tasks.sessions import (
        _sync_agent_sessions,
        _sync_inferred_presence_claims,
    )
