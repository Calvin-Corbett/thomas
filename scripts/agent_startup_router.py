...
try:
    from scripts.workboard_paths import default_workboard_path, repo_relative_or_absolute
except ImportError:  # pragma: no cover
    from workboard_paths import default_workboard_path, repo_relative_or_absolute  # type: ignore
...
DEFAULT_WORKBOARD_READ = repo_relative_or_absolute(DEFAULT_WORKBOARD, repo_root=ROOT)
...
def classify_task(
    *,
    ...
    if workboard_required:
        reads.append(DEFAULT_WORKBOARD_READ)
