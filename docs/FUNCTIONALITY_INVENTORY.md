...
|---|---|---|---|
| Install | `ThomasSetup_0.14.61.exe` | Stable | Recommended public Windows path. Download from GitHub Releases, run the installer, keep Finish setup and launch checked, then complete Easy Setup in the browser. |
