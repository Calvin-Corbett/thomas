...
|---|---|---|---|---|---|
| Windows installer | User-facing | Stable | `ThomasSetup_0.14.64.exe`, `installer/`, `.github/workflows/windows-installer.yml` | `tests/test_windows_installer_assets.py` | Recommended public install path. CI smoke-tests silent install and first-run wizard assets. |
