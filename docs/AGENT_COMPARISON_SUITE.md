...
Canonical benchmark definitions now live under `benchmarks/`. This document is the strategy/spec layer, not the source-of-truth location for active benchmark packs.
