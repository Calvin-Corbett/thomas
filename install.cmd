...
if exist scripts\ensure_discord_bridge_deps.ps1 (
    echo [thomas] Syncing embedded Discord bridge dependencies...
    powershell -NoProfile -ExecutionPolicy Bypass -File scripts\ensure_discord_bridge_deps.ps1 -Root "%CD%"
)
