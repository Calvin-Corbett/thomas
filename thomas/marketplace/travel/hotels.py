...
from thomas.marketplace.travel._exceptions import BookingError, HotelNotAvailableError, OverbookingError
from thomas.marketplace.travel._types import Hotel, HotelBookingStatus, LoyaltyTier
