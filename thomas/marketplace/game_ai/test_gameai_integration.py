...
from thomas.marketplace.game_ai._types import ActionType, GameEntity, NavMeshPolygon, Vec2
from thomas.marketplace.game_ai.behavior_tree import Action, BehaviorTree, BTNodeStatus, Condition, Sequence
from thomas.marketplace.game_ai.goap import Goal, GOAPAction, GOAPPlanner
from thomas.marketplace.game_ai.navmesh import NavMesh, NavMeshQuery
from thomas.marketplace.game_ai.steering import Flee, Seek, SteeringManager
from thomas.marketplace.game_ai.utility_ai import Decision, UtilityAI
...
class TestSteeringWithMultipleBehaviors(unittest.TestCase):
    ...
    def test_flocking_behavior(self):
        ...
        from thomas.marketplace.game_ai.steering import Alignment, Cohesion, Separation
...
class TestStateTransitions(unittest.TestCase):
    ...
    def test_state_driven_behavior(self):
        ...
        from thomas.marketplace.game_ai.state_machine import SimpleState, StateMachine
