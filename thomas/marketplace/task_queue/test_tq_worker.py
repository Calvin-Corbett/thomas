...
from thomas.marketplace.task_queue._exceptions import WorkerError
from thomas.marketplace.task_queue._types import Task, TaskStatus, WorkerConfig
...
class TestWorker:
    ...
    def test_retry_on_failure(self) -> None:
        ...
        from thomas.marketplace.task_queue._types import RetryPolicy
