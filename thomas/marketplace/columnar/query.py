...
from thomas.marketplace.columnar._exceptions import QueryError
from thomas.marketplace.columnar._types import ColumnType, RowGroup
...
class QueryExecutor:
    ...
    def load_row_group(self, row_group: RowGroup, schema: Any) -> None:
        ...
        """
        from thomas.marketplace.columnar.storage import RowGroupReader
