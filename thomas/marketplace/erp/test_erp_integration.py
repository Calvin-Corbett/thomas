...
class TestERPIntegration:
    ...
    def test_complete_purchase_cycle(self, setup_erp) -> None:
        ...
        inv.create_item(
            "SKU001",
            "Widget",
            __import__("thomas.marketplace.erp._types", fromlist=["UnitOfMeasure"]).UnitOfMeasure.PIECE,
            "FIFO",
        )
    ...
    def test_financial_reporting_workflow(self, setup_erp) -> None:
        ...
        from thomas.marketplace.erp._types import JournalEntry
    ...
    def test_procurement_to_inventory(self, setup_erp) -> None:
        ...
        UnitOfMeasure = __import__("thomas.marketplace.erp._types", fromlist=["UnitOfMeasure"]).UnitOfMeasure
