...
from thomas.marketplace.recommender._types import InteractionType, Rating, Recommendation, RecommenderConfig
...
from thomas.marketplace.recommender.evaluation import RatingMetrics, RecommenderEvaluator
from thomas.marketplace.recommender.matrix_factorization import ALSFactorizer
from thomas.marketplace.recommender.pipeline import ExplanationGenerator, RecommendationPipeline
...
class TestRecommendationPipeline:
    ...
    def test_ab_testing_manager(self):
        ...
        from thomas.marketplace.recommender.pipeline import A_BTestManager
