...
def is_tailscale_identity(peer_identity: str, policy: TailscalePolicy | None = None) -> bool:
...
def assert_peer_allowed(peer_identity: str, policy: TailscalePolicy | None = None) -> None:
    policy = policy or TailscalePolicy()
