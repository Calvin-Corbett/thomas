...
from thomas.marketplace.signal_proc._types import Signal, Spectrogram
from thomas.marketplace.signal_proc.fft import fft, frequency_bins, magnitude_spectrum, phase_spectrum
