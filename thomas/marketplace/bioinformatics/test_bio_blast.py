...
from thomas.marketplace.bioinformatics.blast import BLASTDatabase, blast_search, calculate_evalue, format_blast_report
...
class TestBlastReport:
    ...
    def test_format_blast_report_with_hits(self) -> None:
        ...
        from thomas.marketplace.bioinformatics._types import BLASTHit
