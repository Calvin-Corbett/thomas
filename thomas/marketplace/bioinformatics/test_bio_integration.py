...
from thomas.marketplace.bioinformatics.alignment import needleman_wunsch, smith_waterman
from thomas.marketplace.bioinformatics.io_formats import read_fasta, write_fasta_file
from thomas.marketplace.bioinformatics.motifs import PositionWeightMatrix
from thomas.marketplace.bioinformatics.phylogenetics import distance_matrix, upgma_tree
from thomas.marketplace.bioinformatics.protein import isoelectric_point, molecular_weight
...
from thomas.marketplace.bioinformatics.stats import kmer_frequency, sequence_entropy
...
class TestWorkflow:
    ...
    def test_sequence_statistics(self) -> None:
        ...
        from thomas.marketplace.bioinformatics.stats import base_composition, dinucleotide_frequency, gc_skew
...
class TestErrorHandling:
    ...
    def test_invalid_sequence_handling(self) -> None:
        ...
        with pytest.raises(InvalidSequenceError):
            from thomas.marketplace.bioinformatics.sequence import validate_dna
    ...
    def test_empty_sequence_handling(self) -> None:
        ...
        with pytest.raises(InvalidSequenceError):
            from thomas.marketplace.bioinformatics.sequence import gc_content

            gc_content("")

    def test_alignment_validation(self) -> None:
        """Test alignment result validation."""
        from thomas.marketplace.bioinformatics._types import AlignmentResult
