...
test("getVoiceTranscriptionOptions includes wake words, extra hints, and a richer prompt", () => {
  ...
  assert.equal(
    ...
    "Prefer Discord music-control phrasing. The assistant name is Thomas. Common wake phrases include thomas, hey thomas. Common Discord voice commands include join the music chat, play music, stop music, pause music, and turn the music down.",
  );
