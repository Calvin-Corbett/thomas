...
test("normalizeTtsText repairs mojibake punctuation before speech", () => {
  assert.equal(
    normalizeTtsText("Youâ€™re overthinking it â€” keep goingâ€¦"),
    "You're overthinking it keep going.",
  );
});
