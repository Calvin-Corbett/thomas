...
test("media candidate scoring prefers closer song matches over unrelated top hits", () => {
  const entries = [
    {
      title: "PAIN - Shut Your Mouth (OFFICIAL MUSIC VIDEO)",
    ...
    },
    {
      ...
      webpageUrl: "https://youtube.com/watch?v=right",
  ...
  assert.ok(
    scoreMediaCandidate("pain your mains", entries[1]) > scoreMediaCandidate("pain your mains", entries[0]),
  );
  assert.equal(selectBestMediaEntry("pain your mains", entries)?.webpageUrl, "https://youtube.com/watch?v=right");
});
