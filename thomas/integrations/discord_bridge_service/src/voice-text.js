...
const SPEECH_TEXT_REPLACEMENTS = [
  [/â€™/g, "'"],
  [/â€˜/g, "'"],
  [/â€œ/g, '"'],
  [/â€/g, '"'],
...
function normalizeSpeechSymbols(value) {
  let normalized = String(value || "");
  for (const [pattern, replacement] of SPEECH_TEXT_REPLACEMENTS) {
...
export function normalizeTtsText(text) {
  let spoken = normalizeSpeechSymbols(text);
