...
from thomas.signal_proc._types import Signal
...
from thomas.signal_proc.spectral import spectral_centroid, stft, welch_psd
from thomas.signal_proc.synthesis import adsr_envelope, sine_wave, white_noise
from thomas.signal_proc.transforms import dct, hilbert_transform, idct
...
class TestSpectralAnalysisPipeline:
    ...
    def test_spectral_centroid_tracking(self):
        ...
        from thomas.signal_proc.synthesis import chirp
...
class TestFilterDesignAndApplication:
    ...
    def test_cascaded_filtering(self):
        ...
        from thomas.signal_proc.filters import design_highpass_fir
        ...
        from thomas.signal_proc.analysis import spectral_centroid_time
...
class TestAdaptiveProcessing:
    ...
    def test_matched_filtering(self):
        ...
        from thomas.signal_proc.convolution import matched_filter
...
class TestSignalReconstruction:
    ...
    def test_stft_reconstruction(self):
        ...
        from thomas.signal_proc.windows import hanning
        ...
        for i, (mag, phase) in enumerate(zip(spec.magnitude, spec.phase)):
            ...
            # IFFT
            from thomas.signal_proc.fft import ifft
