...
def _try_native_backend(req: NodeCommandStatusRequest) -> NodeCommandStatusResponse | None:
    ...
    candidates: list[tuple[str, str]] = [
        ("thomas.nodes.command_status", "get_command_status"),
        ("thomas.nodes.command_status", "node_command_status"),
        ("thomas.nodes.node_commands", "get_command_status"),
        ("thomas.nodes.node_commands", "command_status"),
        ("thomas.nodes.commands", "get_command_status"),
        ("thomas.nodes.commands", "command_status"),
        ("thomas.nodes.command_store", "get_command_status"),
        ("thomas.nodes.command_store", "read_command_status"),
    ]
