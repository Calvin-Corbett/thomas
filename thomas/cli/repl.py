...
from thomas.cli.repl_panels import ThomasREPLPanelsMixin
...
class ThomasREPL(ThomasREPLActivityMixin, ThomasREPLPanelsMixin, ThomasREPLRuntimeMixin, ThomasREPLAgentMixin):
