...
# placeholder-scope_to_finish: Check in the real source for thomas/eval/__init__.py or replace every import and call site with a source-backed module.
# placeholder-owner: thomas/eval
