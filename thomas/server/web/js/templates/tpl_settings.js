...
${window.renderSettingsAboutSection ? window.renderSettingsAboutSection() : ''}
${window.renderInstallGuardSettingsSection ? window.renderInstallGuardSettingsSection() : ''}
...
<div class="settings-section-head">
<h3>Guardrails</h3>
<p>Owner-controlled trust posture. Stronger modes apply immediately. Weaker modes require local confirmation.</p>
</div>
<div class="settings-grid two-col">
<div class="form-group">
<label for="settingAdvGuardrailsPosture">Guardrails Posture</label>
<select id="settingAdvGuardrailsPosture" class="setup-fluid-select">
...
<p class="settings-inline-note">Guardrails posture controls shell approvals, dangerous tool access, and coding-quality floors separately from token economy.</p>
</section>
<section class="settings-section settings-advanced-only">
<div class="settings-section-head">
...
<p>Managed by Guardrails posture. Stronger postures force this on.</p>
</div>
<label class="toggle-switch">
...
<p>Managed by Guardrails posture. Locked mode forces this on.</p>
</div>
<label class="toggle-switch">
...
<p>Managed by Guardrails posture. Standard and Locked force approval.</p>
</div>
<label class="toggle-switch">
...
<p>Managed by Guardrails posture. Locked disables this.</p>
</div>
<label class="toggle-switch">
