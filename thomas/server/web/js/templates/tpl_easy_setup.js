...
<div class="easy-setup-block">
<h4>Install Guard mode</h4>
<p class="easy-setup-note">Choose how cautious Thomas should be about tool installs and update apply on this checkout. You can change this later in Advanced Settings.</p>
<div class="easy-setup-path-grid" id="easySetupSecurityProfileGrid">
</div>
<div class="easy-setup-note" id="easySetupSecurityProfileHint">Balanced is recommended for most machines.</div>
</div>
