...
(function () {
  ...
  var CSS = [
    '.frp-root{--frp-bg:var(--c-menu-bg,#14161b);--frp-line:var(--c-border,#2a2f38);--frp-fg:var(--c-text,#e7e5e4);',
    '--frp-dim:var(--c-dim,#98a2b3);--frp-accent:var(--c-accent,#2563eb);',
    'font:13px/1.45 ui-sans-serif,system-ui,-apple-system,"Segoe UI",sans-serif;color:var(--frp-fg);',
    'background:var(--frp-bg);border:1px solid var(--frp-line);border-radius:12px;padding:14px;box-sizing:border-box}',
    ...
    '.frp-sub{color:var(--frp-dim);font-size:11.5px;margin-top:2px}',
    '.frp-btn{cursor:pointer;border:1px solid var(--c-accent-line,#33507f);background:var(--frp-accent);color:var(--c-accent-ink,#fff);border-radius:8px;',
    'padding:7px 12px;font:600 12px/1 inherit}',
    '.frp-btn:hover{background:color-mix(in srgb,var(--frp-accent) 86%,#fff)}',
    '.frp-btn[disabled]{opacity:.5;cursor:default}',
    '.frp-btn-ghost{background:transparent;color:var(--frp-dim);border-color:var(--c-border-2,#39404d)}',
    '.frp-btn-ghost:hover{background:var(--c-hover,#1e2229)}',
    '.frp-list{display:flex;flex-direction:column;gap:8px}',
    '.frp-row{border:1px solid var(--frp-line);border-radius:10px;padding:10px;background:var(--c-surface,#181b21)}',
    ...
    '.frp-meta{color:var(--c-muted,#98a2b3);font-size:11px}',
    '.frp-form{display:flex;gap:8px;align-items:stretch}',
    '.frp-input{flex:1 1 auto;min-width:0;background:var(--c-composer-bg,#0f1217);color:var(--frp-fg);border:1px solid var(--c-border-2,#39404d);',
    'border-radius:8px;padding:7px 10px;font:13px/1.4 inherit}',
    '.frp-input:focus{outline:none;border-color:var(--frp-accent)}',
    ...
    '.frp-badge.queued{background:color-mix(in srgb,var(--c-warn,#f6d365) 14%,transparent);color:var(--c-warn,#f6d365);border-color:color-mix(in srgb,var(--c-warn,#f6d365) 38%,transparent)}',
    '.frp-badge.delivered{background:var(--c-accent-soft,#0f3149);color:var(--frp-accent);border-color:var(--c-accent-line,#1d5578)}',
    '.frp-badge.acked{background:color-mix(in srgb,var(--c-success,#5fd39b) 14%,transparent);color:var(--c-success,#5fd39b);border-color:color-mix(in srgb,var(--c-success,#5fd39b) 38%,transparent)}',
    '.frp-badge.failed{background:color-mix(in srgb,var(--c-danger,#f38b8b) 14%,transparent);color:var(--c-danger,#f38b8b);border-color:color-mix(in srgb,var(--c-danger,#f38b8b) 38%,transparent)}',
    '.frp-badge.error{background:color-mix(in srgb,var(--c-danger,#f38b8b) 14%,transparent);color:var(--c-danger,#f38b8b);border-color:color-mix(in srgb,var(--c-danger,#f38b8b) 38%,transparent)}',
    '.frp-badge.sending{background:var(--c-surface-2,#22262e);color:var(--frp-dim);border-color:var(--c-border-2,#39404d)}',
    '.frp-ack-text{color:var(--frp-dim);word-break:break-word}',
    '.frp-empty{color:var(--frp-dim);padding:14px;text-align:center;border:1px dashed var(--frp-line);border-radius:10px}',
    '.frp-error{color:var(--c-danger,#f38b8b);margin-bottom:8px;font-size:12px}',
