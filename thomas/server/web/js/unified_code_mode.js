(function () {
  ...
  modes().registerAdapter('code', {
    enter: async () => { adapterActive = true; updateProjectButton(); render(); await refresh(); },
    leave,
    refresh,
    renderHistory,
