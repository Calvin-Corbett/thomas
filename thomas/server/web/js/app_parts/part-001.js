...
export default [
    ...
    "        id: 'write',",
    "        label: 'Write',",
    "        promptPrefix: 'Mode: Writing-focused response. Use structure, tone, and clarity for the requested audience.',",
    "    },",
    "    analyze: {",
    "        id: 'analyze',",
    "        label: 'Analyze',",
    "        promptPrefix: 'Mode: Analysis first. Compare evidence, highlight assumptions, and summarize risks and recommendations.',",
    "    },",
    "    code: {",
    "        id: 'code',",
    "        label: 'Code',",
    "        promptPrefix: 'Mode: Code assistance. Provide minimal, practical patches and explain integration steps.',",
    "    },",
    "    create_image: {",
    "        id: 'create_image',",
    "        label: 'Create image',",
