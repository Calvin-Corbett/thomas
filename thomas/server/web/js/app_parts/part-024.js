...
export default [
    ...
    "            'Loading Asset Studio audio engine...',",
    ...
    "                notifyUser('Asset Studio audio engine failed to load, using fallback timeline.', { tone: 'warn', durationMs: 2300, debugKind: 'studio' });",
    "                moduleWorkbenchRefreshMode('studio');",
    "            });",
    "        }",
    "        return true;",
    ...
    "    moduleStudioEnsureWorkbenchState(wb);",
    "",
    "    moduleWorkbenchHeader(container, 'Asset Studio Engine', 'Thomas-managed asset pipelines with connected tools, queue orchestration, and delivery outputs.');",
