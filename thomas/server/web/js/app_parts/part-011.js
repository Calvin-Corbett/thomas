...
export default [
    ...
    "}",
    "",
    "function officePointInCorridor(x, y, padding = 0.04) {",
    ...
    "    if (officePointInCorridor(x, y, 0.06)) return true;",
    ...
    "    let slotCount = 4;",
    "    if (area >= 280) slotCount = 6;",
    "    if (area >= 420) slotCount = 8;",
    "    if (safeString(room.id) === 'room-lobby') slotCount = 12;",
    "",
