...
export default [
    ...
    "    agent.nextTaskRoamAt = now + officeRandomRange(1200, 2800);",
    ...
    "            || agent.state === 'spawning'",
    "            || agent.state === 'teleporting'",
    "            || (agent.state === 'walking' && agent.intent === 'task')",
    "        )",
    "    )).length;",
    ...
    "            <span>Active Agents <strong>${activeAgents}</strong></span>",
