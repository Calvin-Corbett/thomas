...
var THEMES = {
    ...
    light: { name: 'Light', tagline: 'Daylight studio, airy', sw: ['#ffffff', '#eef1f6', '#2f6bff'],
      vars: { '--c-bg': '#fafbfc', '--c-sidebar': '#f3f5f8', '--c-surface': '#fff', '--c-surface-2': '#f3f5f8', '--c-hover': 'rgba(20,30,60,0.05)', '--c-border': 'rgba(20,30,60,0.10)', '--c-border-2': 'rgba(20,30,60,0.16)', '--c-text': '#1c2330', '--c-dim': 'rgba(28,35,48,0.66)', '--c-muted': 'rgba(28,35,48,0.46)', '--c-accent': '#2f6bff', '--c-accent-ink': '#fff', '--c-accent-soft': 'rgba(47,107,255,0.10)', '--c-accent-line': 'rgba(47,107,255,0.40)', '--c-user-bg': '#eaeef6', '--c-user-text': '#1c2330', '--c-composer-bg': '#fff', '--c-shadow': '0 14px 40px rgba(20,30,60,0.12)', '--c-danger': '#b3261e', '--c-warn': '#a15c00' } },
