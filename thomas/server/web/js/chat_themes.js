...
var THEMES = {
    ...
    light: { name: 'Light', tagline: 'Daylight studio, airy', sw: ['#ffffff', '#eef1f6', '#2b62f3'],
      vars: { '--c-bg': '#fafbfc', '--c-sidebar': '#f3f5f8', '--c-surface': '#fff', '--c-surface-2': '#f3f5f8', '--c-hover': 'rgba(20,30,60,0.05)', '--c-border': 'rgba(20,30,60,0.10)', '--c-border-2': 'rgba(20,30,60,0.16)', '--c-text': '#1c2330', '--c-dim': 'rgba(28,35,48,0.66)', '--c-muted': 'rgba(28,35,48,0.62)', '--c-accent': '#2b62f3', '--c-accent-ink': '#fff', '--c-accent-soft': 'rgba(43,98,243,0.10)', '--c-accent-line': 'rgba(43,98,243,0.42)', '--c-user-bg': '#eaeef6', '--c-user-text': '#1c2330', '--c-composer-bg': '#fff', '--c-shadow': '0 14px 40px rgba(20,30,60,0.12)', '--c-danger': '#b3261e', '--c-warn': '#a15c00' } },
    ...
    sandstone: { name: 'Sandstone', tagline: 'Warm desert, editorial serif', sw: ['#f4ece0', '#e7d9c4', '#b05233'],
      vars: { '--c-bg': '#f4ede1', '--c-sidebar': '#efe5d6', '--c-surface': '#fbf6ee', '--c-surface-2': '#f1e7d7', '--c-hover': 'rgba(80,52,28,0.06)', '--c-border': 'rgba(90,62,34,0.16)', '--c-border-2': 'rgba(90,62,34,0.26)', '--c-text': '#2f2a22', '--c-dim': 'rgba(47,42,34,0.70)', '--c-muted': 'rgba(47,42,34,0.66)', '--c-accent': '#b05233', '--c-accent-ink': '#fdf6ee', '--c-accent-soft': 'rgba(176,82,51,0.12)', '--c-accent-line': 'rgba(176,82,51,0.45)', '--c-user-bg': '#ece0cd', '--c-user-text': '#2f2a22', '--c-composer-bg': '#fbf6ee', '--c-shadow': '0 14px 40px rgba(90,62,34,0.16)', '--c-danger': '#a33a28', '--c-warn': '#8a4b12' } },
  };
