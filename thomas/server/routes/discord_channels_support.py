...
def append_discord_history_turn_if_needed(
    *,
    cfg: Any,
    request_context: DiscordRequestContext | None,
    session_id: str,
    user_text: str,
    assistant_text: str,
    tool_calls: int = 0,
) -> bool:
    if request_context is None or not request_context.is_discord_origin:
        return False
