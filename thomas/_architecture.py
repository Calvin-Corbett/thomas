...
MODULES = {
    ...
    "agent":       {"tier": "core", "depends_on": ["core", "tools", "memory", "policy", "learning"],
                    "health": "yellow",
    ...
    "conversations": {"tier": "support", "depends_on": ["core"],
                      "health": "green",
    ...
    "benchmarks":    {"tier": "support", "depends_on": ["core"],
                      "health": "green",
    ...
    "groupchat":     {"tier": "support", "depends_on": ["core"],
                      "health": "green",
                      "description": "Multi-participant chat coordination"},
    "human_loop":    {"tier": "support", "depends_on": ["core"],
                      "health": "green",
    ...
    "learning":      {"tier": "support", "depends_on": ["core"],
                      "health": "green",
    ...
    "prompts":       {"tier": "support", "depends_on": ["core"],
                      "health": "green",
                      "description": "Prompt templates, message types, and token helpers"},
    "sandbox":       {"tier": "support", "depends_on": ["core"],
                      "health": "green",
                      "description": "Code execution sandbox abstractions"},
    "tests":         {"tier": "support", "depends_on": ["core", "models", "preferences"],
                      "health": "green",
