...
MODULES = {
    ...
    "asset_studio": {
        "tier": "ext",
        "depends_on": ["core", "server", "integrations", "tools"],
        "health": "yellow",
    ...
    "companion": {
        "tier": "ext",
        "depends_on": ["core", "server", "tools"],
        "health": "green",
        "description": "Companion app framework and store compliance",
    },
    "channels": {
        "tier": "ext",
        "depends_on": ["core", "integrations", "tools"],
        "health": "yellow",
    ...
    "security": {
        "tier": "infra",
        "depends_on": ["core", "server", "plugins", "system", "tools"],
        "health": "green",
