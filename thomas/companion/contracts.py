...
class ModuleContract:
    ...
    def from_dict(cls, data: dict[str, Any]) -> "ModuleContract":
        ...
        permissions = _validate_permissions(
            _as_list_of_text(data.get("permissions"), field="module.permissions")
        )
        ui_schema_version = _validate_semver(
            str(data.get("ui_schema_version") or ""), field="module.ui_schema_version"
        )
...
class UpdateBundleManifest:
    ...
    release_notes: str
    signature: Optional[BundleSignature]
    ...
    def from_dict(cls, data: dict[str, Any]) -> "UpdateBundleManifest":
        ...
        min_kernel_version = _validate_semver(
            str(data.get("min_kernel_version") or ""), field="min_kernel_version"
        )
