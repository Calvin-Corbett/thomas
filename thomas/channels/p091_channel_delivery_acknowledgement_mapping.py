    ...
    if request.channels is not None:
        ...
        if request.config is not None:
            ...
            if config_path is not None:
                ...
                last_missing: Optional[ConfigNotFoundError] = None
...
def build_mapping_from_channels(
    ...
    *,
    ...
    return build_channel_delivery_ack_mapping(
        ChannelDeliveryAckMappingRequest(channels=list(channels), strict=strict)
    )
