...
from thomas.blockchain.crypto import generate_keypair
...
class TestBlockAddition:
    ...
    def test_add_single_block(self, chain, genesis_block):
        ...
        from thomas.blockchain.crypto import derive_address
...
class TestBlockRewards:
    ...
    def test_block_reward_halving(self):
        ...
        from thomas.blockchain.block import get_block_reward
