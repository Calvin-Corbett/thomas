...
from thomas.physics._types import AABB, PhysicsConfig, Ray, RigidBodyType, Sphere, Vec3
from thomas.physics.broadphase import AABBTree, SpatialHashGrid, SweepAndPrune
...
from thomas.physics.constraints import ConstraintSolver
from thomas.physics.integrator import Integrator, SymplecticEulerIntegrator
...
class PhysicsWorld:
    ...
    def raycast(self, ray: Ray) -> RaycastResult:
        ...
        for body in self.bodies:
            ...
            from thomas.physics.collision_detection import ray_sphere_intersection
    ...
    def query_point(self, point: Vec3, radius: float = 0.1) -> list[RigidBody]:
        ...
        for body in self.bodies:
            ...
            from thomas.physics.collision_detection import collide_sphere_sphere
